...
#/home/zhongpan/Desktop/zp/TargetCall/bonito/bonito/data/chunks.npy

model_path = '../bonito/models/' + model_name + '/'


os.system("bonito basecaller " + model_path + " " + read_dir_path + "/ --batchsize " + str(batch) +" --modeltype "+ modeltype + " > " + out_dir_path + '/output.fastq' + " " + "--verbose")

#os.system("bonito basecaller " + model_path + " --save-ctc --reference reference.mmi ../bonito/bonito/data/ --batchsize " + str(batch) + " --modeltype " + modeltype + " > ../bonito/bonito/data/training/ctc-data/basecalls.sam" )

#os.system("bonito train -f ../bonito/models/TINYX011 --directory ../Klebsiella_pneumoniae_KSB1_7F/training_fast5s/0000/" )
